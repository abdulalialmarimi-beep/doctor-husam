...
async def check_bad_words(message: discord.Message) -> bool:
    ...
    await message.channel.send(
        f"🔇 ميوت لـ {message.author.mention} لمدة **{mute_duration} دقيقة** بسبب السب | {admins_mention}"
    )
    return True

SYSTEM_PROMPT = """أنت دكتور حسام — مساعد ذكي وشخصية خفيفة.

- ترد بنفس لغة الشخص
- أسلوبك طبيعي وخفيف مثل صديق
- تمزح بس بشكل طبيعي مو مبالغ
- ما تحط ايموجي في كل جملة — بالكثير ايموجي أو اثنين في الرد كله
- ردودك قصيرة ومباشرة
- تساعد في أي موضوع
- أحياناً اسأل سؤال واحد بس للتفاعل"""
